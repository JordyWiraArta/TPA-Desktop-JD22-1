...
import { updateCardList } from '../js/ListController';
import { CardRef } from '../js/CardController';

export default function CreateCardPopUp({listId, setCardCreate, ...Attr}) {
